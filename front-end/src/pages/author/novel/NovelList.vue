        ...
        <tbody v-if="novels.length > 0" >
          ...
          >
            ...
            <td class="px-4 py-3 flex justify-center gap-3">
              <RouterLink
                :to="{name: 'NovelAuthorDetail', params:{id: novel.id } }"
                class="text-blue-600 hover:text-blue-800"
              >
                <Eye class="w-5 h-5" />
              </RouterLink>
              <RouterLink
                :to="{name: 'NovelAuthorEdit', params:{id: novel.id} }"
              ...
              <RouterLink 
              :to="{name: 'ChapterAuthorList', params: {novelId: novel.id } }"
