  ...
  <div>
    ...
    <template v-else>
      <div  class="flex items-center justify-between mb-6">
        ...
        <RouterLink
          :to="{name: 'ChapterAuthorCreate', params: {novelId: novelId } }"
          ...
          <tbody v-if="chapters.length > 0" >
            ...
            >
              ...
              <td class="px-4 py-3 flex justify-center gap-3">
                <RouterLink :to="{name: 'ChapterAuthorDetail', params: {id: chapter.id} }" class="text-blue-600 hover:text-blue-800">
                  <Eye class="w-5 h-5" />
                </RouterLink>

                <RouterLink :to="{name: 'ChapterAuthorEdit', params: {id: chapter.id} }" class="text-green-600 hover:text-green-800">
                  <Edit class="w-5 h-5" />
                </RouterLink>
